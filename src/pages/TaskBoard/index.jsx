        ...
        <div className="size-full flex flex-col">
            ...
            <div className="px-8 py-5 flex-1 flex flex-col min-h-0">
                ...
                <div className="grid grid-cols-4 gap-8 flex-1 mt-4 min-h-0">
                    <TaskList status="todo" title="To Do" color="blue" />
                    <TaskList status="in-progress" title="In Progress" color="red" />
                    <TaskList status="review" title="Review" color="orange" />
                    <TaskList status="done" title="Done" color="green" />
                </div>
                <Button
                    variant="text"
